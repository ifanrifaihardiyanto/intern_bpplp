if ($("#dashboardDateYear").length) {
  $("#dashboardDateYear").datepicker({
    format: "yyyy",
    viewMode: "years",
    minViewMode: "years",
  });

  var oldDate = $("#dashboardDateYear input").attr("date-update");
  $("#dashboardDateYear").datepicker("update", oldDate);
}

if ($("#dashboardDateMonth").length) {
  $("#dashboardDateMonth").datepicker({
    format: "mm-yyyy",
    viewMode: "months",
    minViewMode: "months",
    autoclose: true,
  ...
  var oldDate = $("#dashboardDateMonth input").attr("date-update");
  $("#dashboardDateMonth").datepicker("update", oldDate);
}

if ($('#monthPickerExample').length) {
  var date = new Date();
  var today = new Date(date.getFullYear(), date.getMonth(), date.getDate());
  $('#monthPickerExample').datepicker({
    format: "yyyy-mm",
    // minViewMode: 1,
    startView: "months",
    minViewMode: "months",
  ...
  // $('#monthPickerExample').datepicker('setDate', today);
}

if ($("#dashboardDateQuarterly").length) {
  ...
  var oldDate = $("#dashboardDateQuarterly input").attr("date-update");
  console.log(oldDate);
  $("#dashboardDateQuarterly").datepicker("update", oldDate);
}
...
$(function () {
  ...
  if ($("#dashboardDate").length) {
    ...
    var oldDate = $("#dashboardDate input").attr("date-update");
    $("#dashboardDate").datepicker("update", oldDate);
  }
  // Dashbaord date end

  // Dashbaord due date start
  if ($("#dashboardDueDate").length) {
    $("#dashboardDueDate").datepicker({
      format: "dd-MM-yyyy",
      todayHighlight: true,
      autoclose: true,
    });

    var oldDate = $("#dashboardDueDate input").attr("date-update");
    $("#dashboardDueDate").datepicker("update", oldDate);
  }
  // Dashbaord due date end

  // Dashbaord legal entry date start
  if ($("#dashboardLegalEntryDate").length) {
    $("#dashboardLegalEntryDate").datepicker({
      format: "dd-MM-yyyy",
      todayHighlight: true,
      autoclose: true,
    });

    var oldDate = $("#dashboardLegalEntryDate input").attr("date-update");
    $("#dashboardLegalEntryDate").datepicker("update", oldDate);
  }
  // Dashbaord legal entry date end

  // Dashbaord legal back date start
  if ($("#dashboardLegalBackDate").length) {
    $("#dashboardLegalBackDate").datepicker({
      format: "dd-MM-yyyy",
      todayHighlight: true,
      autoclose: true,
    });

    var oldDate = $("#dashboardLegalBackDate input").attr("date-update");
    $("#dashboardLegalBackDate").datepicker("update", oldDate);
  }
  // Dashbaord legal back date end

  // Dashbaord legal exit date start
  if ($("#dashboardLegalExitDate").length) {
    $("#dashboardLegalExitDate").datepicker({
      format: "dd-MM-yyyy",
      todayHighlight: true,
      autoclose: true,
    });

    var oldDate = $("#dashboardLegalExitDate input").attr("date-update");
    $("#dashboardLegalExitDate").datepicker("update", oldDate);
  }
  // Dashbaord legal exit date end
